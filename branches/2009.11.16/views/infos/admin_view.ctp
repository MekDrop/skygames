...
<?php $i = 0; $class = ' class="altrow"';?>
	...
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $info['Info']['id']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Title'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $info['Info']['title']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Desc'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $info['Info']['desc']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Body'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $info['Info']['body']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Created'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $info['Info']['created']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Modified'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $info['Info']['modified']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('User'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $html->link($info['User']['name'], array('controller'=> 'users', 'action'=>'view', $info['User']['id'])); ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Infocat'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $html->link($info['Infocat']['name'], array('controller'=> 'infocats', 'action'=>'view', $info['Infocat']['id'])); ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Lang'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $html->link($info['Lang']['name'], array('controller'=> 'langs', 'action'=>'view', $info['Lang']['id'])); ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Game'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $html->link($info['Game']['name'], array('controller'=> 'games', 'action'=>'view', $info['Game']['id'])); ?>
	&nbsp;</dd>
</dl>
</div>
<div class="actions">
<ul>
	<li><?php echo $html->link(__('Edit Info', true), array('action'=>'edit', $info['Info']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('Delete Info', true), array('action'=>'delete', $info['Info']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $info['Info']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('List Infos', true), array('action'=>'index')); ?>
	</li>
	<li><?php echo $html->link(__('New Info', true), array('action'=>'add')); ?>
	</li>
...
<table cellpadding="0" cellspacing="0">
	...
	<tr <?php echo $class;?>>
		...
		<td class="actions"><?php echo $html->link(__('View', true), array('controller'=> 'infocomments', 'action'=>'view', $infocomment['id'])); ?>
