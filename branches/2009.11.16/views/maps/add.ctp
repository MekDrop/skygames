<div class="maps form"><?php echo $form->create('Map');?>
<fieldset><legend><?php __('Add Map');?></legend> <?php
...
<ul>
	...
	<li><?php echo $html->link(__('List Results', true), array('controller'=> 'results', 'action'=>'index')); ?>
	</li>
	<li><?php echo $html->link(__('New Result', true), array('controller'=> 'results', 'action'=>'add')); ?>
	</li>
</ul>
</div>
