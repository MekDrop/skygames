<script type="text/javascript">
	document.write(unescape('%3C') + 'link rel="stylesheet" type="text/css" media="screen" href="/css/tablo/<?php echo $playofftable['Playofftable']['theme']; ?>.css" /' + unescape('%3E'));
</script>

<div class="background">

<div align="center" class="background"><?php //if (!empty($playofftable['Match'])):?>
<table cellpadding="0" cellspacing="0" border="0" width="auto">
	...
	<?php for ($i = 1;$i <= log($playofftable['Playofftable']['size'], 2); $i++):?>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				<th class="tableheader"><?php __('Playoff round'); ?>&nbsp;<?php echo $i; ?></th>
				<th class="narrowvoidcell"></th>
			</tr>
		</table>
		</td>
		<?php endfor;?>
	...
	?>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<?php if ((pow(2, $x) * $match['Match']['tposition_y'] - pow(2, $x - 1)) == $y):?>
				...
				<td class="voidcellfull" style="text-align: center"><?php if (count($match['Result']) > 0): ?>
				<?php echo $match['Result'][0]['team1_score']; ?><?php echo " : "; ?><?php echo $match['Result'][0]['team2_score'];?>
				<?php endif; ?></td>
				<td class="lcentercell"></td>
				<?php endif; ?>
				<?php if ((pow(2, $x) * $match['Match']['tposition_y'] - pow(2, $x - 1)) == $y - pow(2, $x - 2)):?>

				<td class="playercell"><?php echo $match['Team2']['tag'];?></td>
				<td class="brcornercell"></td>
				<?php $drawLine[$x] = false; ?>

				<?php endif; ?>
				<?php if ((pow(2, $x) * $match['Match']['tposition_y'] - pow(2, $x - 1)) == $y + pow(2, $x - 2)):?>

				<td class="playercell"><?php echo $match['Team1']['tag'];?></td>
				<td class="trcornercell"></td>
				<?php $drawLine[$x] = true; ?>
		...
		<?php endif; ?> <?php else: ?> <?php if ( fmod($y-pow(2, $x - 1), pow(2, $x)) == 0 || fmod($y - pow(2, $x - 2) - pow(2, $x - 1), pow(2, $x)) == 0 || fmod($y + pow(2, $x - 2) - pow(2, $x - 1), pow(2, $x)) == 0): ?>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<?php if (fmod($y-pow(2, $x - 1), pow(2, $x)) == 0):?>
				<td class="voidcellfull" style="text-align: center" width="100%"></td>
				<td class="lcentercell"></td>
				<?php endif; ?>
				<?php if (fmod($y - pow(2, $x - 2) - pow(2, $x - 1), pow(2, $x)) == 0):?>

				<td class="playercell">&nbsp;&nbsp;---&nbsp;&nbsp;</td>
				<td class="brcornercell"></td>
				<?php $drawLine[$x] = false; ?>
				<?php endif; ?>
				<?php if (fmod($y + pow(2, $x - 2) - pow(2, $x - 1), pow(2, $x)) == 0):?>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr>
				<td class="voidcellfull" style="text-align: center"></td>
				<td class="lcentercell"></td>
			</tr>
			<tr>
				<td class="playercell">&nbsp;&nbsp;---&nbsp;&nbsp;</td>
		...
		<?php endif; ?> <?php else: ?> <?php if ($drawLine[$x]): ?>
		...
		<?php endif; ?> <?php endif; ?> <?php endif; ?></td>
		<!-- 
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr>
			<?php if (fmod($y-pow(2, $x - 1), pow(2, $x)) == 0):?>
				<td class="playercell" style="text-align: center"><?php if (count($match['Result']) > 0): ?>
				<?php if ($match['Result'][0]['team2_score'] > $match['Result'][0]['team1_score']): ?>
				<?php echo $match['Team2']['tag'];?> <?php else: ?> <?php echo $match['Team1']['tag']; ?>
...
<!-- 
	 ...
	 <?php if ($playofftable['Playofftable']['type'] == 'D'):?> <?php
		$match = null;
		foreach ($pmatches as $searchMatch)
...
<table cellpadding="0" cellspacing="0">
	<tr>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				<td class="narrowvoidcell"></td>
				<th class="tableheader"><?php __('Final'); ?></th>
				<th class="narrowvoidcell"></th>
			</tr>
		</table>
		</td>
	...
	<tr>
		...
		<td align="center"><?php if (!empty($match)):?>


		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				<td class="narrowvoidcell"></td>
				<td class="playercell">&nbsp;&nbsp;<?php echo $match['Team1']['tag'];?>&nbsp;&nbsp;
				</td>
				<td class="trcornercell"></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="narrowvoidcell"></td>
				<td class="playercell">&nbsp;&nbsp;<?php echo $match['Team2']['tag'];?>&nbsp;&nbsp;
				</td>
				<td class="brcornercell"></td>
			</tr>
		</table>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<tr>
				<td class="playercell" style="text-align: center"><?php if (count($match['Result']) > 0): ?>
				<?php if ($match['Result'][0]['team2_score'] > $match['Result'][0]['team1_score']): ?>
				&nbsp;&nbsp;<?php echo $match['Team2']['tag'];?>&nbsp;&nbsp; <?php else: ?>
				&nbsp;&nbsp;<?php echo $match['Team1']['tag']; ?>&nbsp;&nbsp; <?php endif; ?>
				<?php endif; ?></td>
				<td class="narrowvoidcell"></td>
			</tr>
			<tr>
	...
	?>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tr>
				...
				<?php if( $match['Result'][0]['team2_score'] > $match['Result'][0]['team1_score']): ?>
				<td class="tlcornercell"></td>
				<?php else: ?>
				<td class="hlinecell"></td>
				<?php endif; ?>
			</tr>
			<tr>

				<td class="voidcellfull"><?php if (count($match['Result']) > 0): ?>
				<?php echo $match['Result'][0]['team1_score']; ?><?php echo " : "; ?><?php echo $match['Result'][0]['team2_score'];?>
				<?php endif; ?></td>
				<?php if( $match['Result'][0]['team2_score'] > $match['Result'][0]['team1_score']): ?>
				<td class="lvlinecell"></td>
		...
		<?php else: ?> <?php if ( fmod($y-pow(2, $x - 1), pow(2, $x)) == 0): ?>
