...
<table cellpadding="0" cellspacing="0">
	...
	<tr <?php echo $class;?>>
		...
		<td class="actions"><?php echo $html->link(__('View', true), array('action'=>'view', $eventtype['Eventtype']['id'])); ?>
		<?php echo $html->link(__('Edit', true), array('action'=>'edit', $eventtype['Eventtype']['id'])); ?>
		<?php echo $html->link(__('Delete', true), array('action'=>'delete', $eventtype['Eventtype']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $eventtype['Eventtype']['id'])); ?>
		</td>
	</tr>
	<?php endforeach; ?>
</table>
