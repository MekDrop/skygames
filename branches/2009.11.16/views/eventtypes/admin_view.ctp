...
<?php $i = 0; $class = ' class="altrow"';?>
	...
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $eventtype['Eventtype']['id']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $eventtype['Eventtype']['name']; ?>
	&nbsp;</dd>
</dl>
</div>
<div class="actions">
<ul>
	<li><?php echo $html->link(__('Edit Eventtype', true), array('action'=>'edit', $eventtype['Eventtype']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('Delete Eventtype', true), array('action'=>'delete', $eventtype['Eventtype']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $eventtype['Eventtype']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('List Eventtypes', true), array('action'=>'index')); ?>
	</li>
	<li><?php echo $html->link(__('New Eventtype', true), array('action'=>'add')); ?>
	</li>
