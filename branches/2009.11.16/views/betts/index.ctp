...
<table cellpadding="0" cellspacing="0">
	...
	?>
	<tr <?php echo $class;?>>
		<td><?php echo $bett['Bett']['id']; ?></td>
		<td><?php echo $bett['Bett']['match_id']; ?></td>
		<td><?php echo $bett['Bett']['team_id']; ?></td>
		<td><?php echo $bett['Bett']['sum']; ?></td>
		<td><?php echo $bett['Bett']['odds']; ?></td>
		<td><?php echo $bett['Bett']['user_id']; ?></td>
		<td class="actions"><?php echo $html->link(__('View', true), array('action'=>'view', $bett['Bett']['id'])); ?>
