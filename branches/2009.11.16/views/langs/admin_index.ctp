...
<table cellpadding="0" cellspacing="0">
	...
	?>
	<tr <?php echo $class;?>>
		<td><?php echo $lang['Lang']['id']; ?></td>
		<td><?php echo $lang['Lang']['name']; ?></td>
		<td><?php echo $lang['Lang']['code']; ?></td>
		<td class="actions"><?php echo $html->link(__('View', true), array('action'=>'view', $lang['Lang']['id'])); ?>
