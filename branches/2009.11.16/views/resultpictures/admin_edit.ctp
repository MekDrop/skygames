...
<?php echo $form->create('Resultpicture');?>
	<fieldset>
 		<legend><?php __('Edit Resultpicture');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('Resultpicture.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Resultpicture.id'))); ?></li>
