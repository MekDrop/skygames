...
class EmailComponent
{
   ...
   */
    var $from         = 'info@skygames.lt';
    var $fromName     = "SkyGames.lt";
    var $smtpUserName = '';  // SMTP username
    var $smtpPassword = ''; // SMTP password
    var $smtpHostNames= "smtp.skynet.lt";  // specify main and backup server
    var $text_body = null;
    var $html_body = null;
    var $to = null;
    var $toName = null;
    ...
    function send()
    {
    require_once('vendors'.DS.'phpmailer'.DS.'class.phpmailer.php');    
