...
<?php $i = 0; $class = ' class="altrow"';?>
	...
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $group['Group']['level']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Redirect'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $group['Group']['redirect']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Perm Type'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $group['Group']['perm_type']; ?>
	&nbsp;</dd>
...
<div class="actions">
<ul>
	<li><?php echo $html->link(__('Edit Group', true), array('action'=>'edit', $group['Group']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('Delete Group', true), array('action'=>'delete', $group['Group']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $group['Group']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('List Groups', true), array('action'=>'index')); ?>
	</li>
	<li><?php echo $html->link(__('New Group', true), array('action'=>'add')); ?>
	</li>
...
<table cellpadding="0" cellspacing="0">
	...
	<tr <?php echo $class;?>>
		...
		<td class="actions"><?php echo $html->link(__('View', true), array('controller'=> 'users', 'action'=>'view', $user['id'])); ?>
...
<table cellpadding="0" cellspacing="0">
	...
	<tr <?php echo $class;?>>
		...
		<td class="actions"><?php echo $html->link(__('View', true), array('controller'=> 'permissions', 'action'=>'view', $permission['id'])); ?>
