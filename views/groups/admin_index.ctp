...
<table cellpadding="0" cellspacing="0">
	<tr>
		...
		<th><?php echo $paginator->sort('redirect');?></th>
		<th><?php echo $paginator->sort('perm_type');?></th>
	...
	<tr <?php echo $class;?>>
		...
		<td><?php echo $group['Group']['level']; ?></td>
		<td><?php echo $group['Group']['redirect']; ?></td>
		<td><?php echo $group['Group']['perm_type']; ?></td>
		<td><?php echo $group['Group']['created']; ?></td>
		<td><?php echo $group['Group']['modified']; ?></td>
		<td class="actions"><?php echo $html->link(__('View', true), array('action'=>'view', $group['Group']['id'])); ?>
