...
?>
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo strip_tags(substr($info['Info']['desc'],0,64)); ?>
		</td>
		<td>
			<?php echo strip_tags(substr($info['Info']['body'],0,64)); ?>
		</td>
		<td>
		...
		<td class="actions">
			<?php echo $html->link(__('View', true), array('action'=>'view', $info['Info']['id'])); ?><br/>
