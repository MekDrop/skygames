...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Lang', true), array('action'=>'edit', $lang['Lang']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Lang', true), array('action'=>'delete', $lang['Lang']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $lang['Lang']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $html->link(__('View', true), array('controller'=> 'threadcats', 'action'=>'view', $threadcat['id'])); ?>
