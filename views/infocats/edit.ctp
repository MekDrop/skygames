<div class="infocats form"><?php echo $form->create('Infocat');?>
<fieldset><legend><?php __('Edit Infocat');?></legend> <?php
echo $form->input('id');
...
<div class="actions">
<ul>
	<li><?php echo $html->link(__('Delete', true), array('action'=>'delete', $form->value('Infocat.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $form->value('Infocat.id'))); ?></li>
