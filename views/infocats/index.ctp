...
<table cellpadding="0" cellspacing="0">
	...
	?>
	<tr <?php echo $class;?>>
		<td><?php echo $infocat['Infocat']['id']; ?></td>
		<td><?php echo $infocat['Infocat']['name']; ?></td>
		<td><?php echo $html->link($infocat['Game']['name'], array('controller'=> 'games', 'action'=>'view', $infocat['Game']['id'])); ?>
		</td>
		<td class="actions"><?php echo $html->link(__('View', true), array('action'=>'view', $infocat['Infocat']['id'])); ?>
