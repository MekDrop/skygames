...
<table cellpadding="0" cellspacing="0">
	...
	<tr <?php echo $class;?>>
		...
		<td><?php echo $feed['Feed']['name']; ?></td>
		<td><?php echo $feed['Feed']['url']; ?></td>
		<td><?php echo $feed['Feed']['show']; ?></td>
		<td><?php echo $html->link($feed['Game']['name'], array('controller'=> 'games', 'action'=>'view', $feed['Game']['id'])); ?>
		</td>
		<td class="actions"><?php echo $html->link(__('View', true), array('action'=>'view', $feed['Feed']['id'])); ?>
