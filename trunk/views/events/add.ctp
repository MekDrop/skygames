...
<td valign="top">	
	<div class="events form">
			...
			<?php
				...
				echo $form->select('teamcount', array("4"=>"4","8"=>"8","16"=>"16","32"=>"32"), array('class' => 'ivestis'), array('onchange' => 'limitTabloThemes(this)'), false);
				...
				echo $form->input('eventtype_id', array("type"=>"hidden", "value"=>"1"));
