...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Edit Game', true), array('action'=>'edit', $game['Game']['id'])); ?> </li>
		<li><?php echo $html->link(__('Delete Game', true), array('action'=>'delete', $game['Game']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $game['Game']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $html->link(__('View', true), array('controller'=> 'matchparts', 'action'=>'view', $matchpart['id'])); ?>
...
<div class="related">
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				<?php echo $html->link(__('View', true), array('controller'=> 'gamewords', 'action'=>'view', $gameword['id'])); ?>
