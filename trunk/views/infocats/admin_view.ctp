...
<?php $i = 0; $class = ' class="altrow"';?>
	...
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $infocat['Infocat']['id']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Name'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $infocat['Infocat']['name']; ?>
	&nbsp;</dd>
	<dt <?php if ($i % 2 == 0) echo $class;?>><?php __('Game'); ?></dt>
	<dd <?php if ($i++ % 2 == 0) echo $class;?>><?php echo $html->link($infocat['Game']['name'], array('controller'=> 'games', 'action'=>'view', $infocat['Game']['id'])); ?>
	&nbsp;</dd>
</dl>
</div>
<div class="actions">
<ul>
	<li><?php echo $html->link(__('Edit Infocat', true), array('action'=>'edit', $infocat['Infocat']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('Delete Infocat', true), array('action'=>'delete', $infocat['Infocat']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $infocat['Infocat']['id'])); ?>
	</li>
	<li><?php echo $html->link(__('List Infocats', true), array('action'=>'index')); ?>
	</li>
	<li><?php echo $html->link(__('New Infocat', true), array('action'=>'add')); ?>
	</li>
