...
<table cellpadding="5" cellspacing="0" class="list">
	...
	<tr>
		...
		<table border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td colspan="2"><?php echo $info['Info']['body']; ?></td>
			</tr>
			<tr>
				...
				<table cellspacing="0" cellpadding="0" border="0"
					...
					<tr>
						<td style="vertical-align: middle;"><?php __('By');?>:</td>
...
<?php echo $this->renderElement('comments', array('cache'=>false, 'commentsModel' => 'Infocomment', 'commentParentName' => 'info_id', 'commentParentValue' => $info['Info']['id']));?>
